import{a as f,_ as hi,b as ui,c as di,d as Me,e as fi,f as _i,C as pi,r as cn,h as N,j as Dt,k as B,l as gi,S as mi,m as yi,n as de,p as ze,L as vi,q as Oe,t as Bn,u as Ci,v as Yn,D as zn,w as Ei,x as Ii,y as hn,z as Kn,A as Ti,B as wi,E as rt,F as Si,G as Ni,H as Ri}from"./index-e5b3cc81-e712630f.js";const un="@firebase/database",dn="0.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ll(n){bi(Ni),_i(new pi("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Pl(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),cn(un,dn,n),cn(un,dn,"esm2017")}V.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};V.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Ll();export{Ul as a,Pt as c,Gl as g,Wl as r};
