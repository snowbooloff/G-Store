import{u as me}from"./runtime-dom.esm-bundler-2e7369a8.js";import{u as we}from"./vuex.esm-bundler-b3703aab.js";import{d as be,g as ye,o as D,a as W,u as X,c as ke,f as Re,_ as Te}from"./-plugin-vue-export-helper-b66d6dea.js";import{d as B,_ as Ce,b as Se,c as xe,f as ve,C as Ae,r as G,e as Pe,G as Ee,I as Ue,J as Ie}from"./index-e5b3cc81-e712630f.js";const Be={class:"user-avatar"},Oe=["src"],Le=be({__name:"UserAvatar",props:{size:null},setup(t){me(r=>({"8e247778":t.size}));const e=we(),n=ye(()=>e.state.user.userInfo.image);return(r,s)=>{const o=Re("icon-user");return D(),W("div",Be,[X(n)?(D(),W("img",{key:1,src:X(n),class:"user-avatar__img"},null,8,Oe)):(D(),ke(o,{key:0,class:"user-avatar__icon main-white"}))])}}});const Yt=Te(Le,[["__scopeId","data-v-6457547e"]]);/**
 * @license
